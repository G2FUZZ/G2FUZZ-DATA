...
def batch_processing(input_folder, output_folder, new_width, new_height, compression_levels):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".jpg"):
            ...
            for level in compression_levels:
                ...
                output_subfolder = os.path.join(output_folder, f'compression_{level}')
                if not os.path.exists(output_subfolder):
                    os.makedirs(output_subfolder)
                output_path = os.path.join(output_subfolder, f'resized_{filename}')
                resized_image.save(output_path, quality=level)
...
batch_processing(input_folder, output_folder, new_width, new_height, compression_levels)