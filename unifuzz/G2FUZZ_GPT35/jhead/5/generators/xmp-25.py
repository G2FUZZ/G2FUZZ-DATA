...
# Generate the xmp file with more complex file structures and additional custom metadata
xmp_content = """
    ...
    <rdf:Description rdf:about=""
      ...
      <custom:CustomMetadata xmlns:custom="http://example.com/custom/">
        ...
        <custom:AdditionalMetadata>
          <custom:Feature1>Value1</custom:Feature1>
          <custom:Feature2>Value2</custom:Feature2>
        </custom:AdditionalMetadata>
