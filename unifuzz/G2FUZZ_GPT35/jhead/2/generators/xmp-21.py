...
# Define the content of the extended XMP file
...
with open('./tmp/extended_custom_metadata.xmp', 'w') as file:
    file.write(xmp_content_extended)

print("Extended XMP file with custom metadata fields and nested structures generated and saved successfully.")