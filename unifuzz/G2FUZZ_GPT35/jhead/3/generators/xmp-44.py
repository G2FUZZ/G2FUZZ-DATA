...
# Generate xmp files with complex file features
num_files = 5
        ...
        <x:xmpmeta xmlns:x="adobe:ns:meta/" x:xmptk="Adobe XMP Core 5.6-c067 79.157747, 2015/03/30-23:40:42">
            <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                <rdf:Description rdf:about=""
                    ...
                    <dc:description>This is a complex XMP file with structured data</dc:description>
...
print(f"{num_files} xmp files with complex file features generated and saved in './tmp/' directory.")