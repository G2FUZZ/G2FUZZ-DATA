...
def generate_complex_bmp(filename, width, height, num_channels=3, compression=True, color_palette=None):
    header_size = 54
...
color_palette = [0xFF0000, 0x00FF00, 0x0000FF, 0xFFFF00]  # Example color palette
generate_complex_bmp('./tmp/complex_image.bmp', 200, 150, num_channels=4, compression=True, color_palette=color_palette)