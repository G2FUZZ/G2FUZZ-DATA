...
# Combine the silent segments into a single track, with a pan effect
combined_silence = silence_sine.pan(-1) + silence_square.pan(0) + silence_sawtooth.pan(1)  # Left, center, right pan
