...
# Create a base image
img = Image.new('RGB', (800, 600), color='skyblue')  # The color was already mutated
...
draw.text((10, 10), "Complex Sample Image", fill="white", font=font)  # Text and font customization already applied

# Create a watermark
watermark_text = "Watermarked"
watermark = Image.new('RGBA', img.size, (255,255,255,0))
watermark_draw = ImageDraw.Draw(watermark)
watermark_draw.text((600, 560), watermark_text, fill=(255,255,255,128), font=font)  # Watermark application unchanged
...
thumbnail = thumbnail.rotate(45, expand=True)  # Thumbnail rotation unchanged
...
exif_bytes = b"Exif\x00\x00" + bytes(str(exif_data), 'utf-8')  # EXIF data embedding unchanged

# Save the watermarked image with an embedded thumbnail and mock EXIF data to a file
output_path = os.path.join(output_dir, 'complex_sample_with_thumbnail.jpg')  # Output file naming convention unchanged
